...
class TestConfig(unittest.TestCase):
    ...
    def test_default_config(self):  #тест дефолтных настроек
        config = Config()
    ...
    def test_set_and_get(self):  #тест установка и получение значений
        config = Config()
    ...
    def test_nested_keys(self):  #вложенные ключи
        config = Config()
    ...
    def test_default_value(self):  #тест дефолтные значения
        config = Config()
